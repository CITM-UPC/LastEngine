...
size_t PerformancePanel::GetProcessMemoryUsage() const {
#ifdef _WIN32
...
//std::string PerformancePanel::FormatMemorySize(size_t bytes) const {
...
void PerformancePanel::DrawPerformanceWindow() {
